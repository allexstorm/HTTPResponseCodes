...
package com.alexandersamtsov.httpresponsecodes;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String packagePath = "/com/alexandersamtsov/httpresponsecodes/";
        String line;
        ...
        try {
            while ((line = br.readLine()) != null) {
                ...
                try{
                    ...
                    if (code == 200) {
                        System.out.println(ANSI_GREEN + line + " is available!" + " Response code: " + code + ANSI_RESET);
                        bwr.write(line + " is available! Response code: " + code + "\n");
                    }
                    else
                    {
                        System.out.println(ANSI_YELLOW + line + " is available, but response code is " + code + ANSI_RESET);
                        bwr.write(line + " is available, but response code is " + code + "\n");
                    }
